...
st.title("Tree Growth Rings Simulation - Linear Core Visualization with Voronoi Cells (Zoom Enabled)")
...
for idx, region in enumerate(regions):
    ...
    # Add Voronoi cell to Plotly figure
    fig.add_trace(go.Scatter(
        ...
        line=dict(width=cell['cell_wall_thickness']),
        name=f"Year: {cell['Year']}, {cell['cell_type']}"
    ))

# Customize layout for zooming and interaction
fig.update_layout(
    title="Linear Core Visualization with Voronoi Cells (Zoom Enabled)",
