...
The failure of ecologists to use the term "self-affine" to describe fractal behavior appears to be limited to a few authors publishing in plant and forest ecology. Microbial ecologists and marine ecologists (Seuront) seem to have a better understanding of self-affinity and its consequences.
